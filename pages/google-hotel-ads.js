...
export default function Page() {
  ...
  return (
    <>
            <Head>
        <title>Google Hotel Ads Management Services | Apex Bookings</title>
        <meta name="description" content="Drive direct hotel bookings through Google Hotel Ads. Apex Bookings helps hotels reduce OTA dependency and increase direct revenue."/>
        <meta name="keywords" content="google hotel ads agency india, hotel metasearch management, direct hotel bookings, hotel marketing india"/>
