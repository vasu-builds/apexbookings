...
export default function Page() {
  ...
  return (
    <>
            <Head>
        <title>Cloud PMS Software for Hotels in India | Apex Bookings</title>
        <meta name="description" content="Streamline hotel operations with cloud-based PMS software for reservations, check-ins, housekeeping, invoicing & OTA integration."/>
