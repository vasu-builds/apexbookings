...
export default function Page() {
  ...
  return (
    <>
            <Head>
        <title>Cloud POS Software for Hotels & Restaurants | Apex Bookings</title>
        <meta name="description" content="Simplify hotel and restaurant billing with Apex Bookings Cloud POS. Manage GST billing, room service, restaurant orders & online payments from one dashboard."/>
