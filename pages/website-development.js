        ...
        <div className="container" style={{position:'relative',zIndex:1}}>
          <div className="inner-hero-layout">
            <div>
              ...
              <p style={{fontSize:16,color:'rgba(255,255,255,0.75)',lineHeight:1.8,maxWidth:460,marginBottom:36,fontWeight:400}}>Custom, mobile-first hotel websites built to turn visitors into direct bookings. Integrated booking engine, SEO-optimized, and Google Hotel Ads ready.</p>
