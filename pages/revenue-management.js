...
export default function Page() {
  ...
  return (
    <>
            <Head>
        <title>Hotel Revenue Management Services in India | Apex Bookings</title>
        <meta name="description" content="Increase ADR, RevPAR & hotel occupancy with data-driven hotel revenue management services by Apex Bookings hospitality experts."/>
        ...
        <div className="container" style={{position:'relative',zIndex:1}}>
          <div className="inner-hero-layout">
            <div>
              ...
              <p style={{fontSize:16,color:'rgba(255,255,255,0.75)',lineHeight:1.8,maxWidth:460,marginBottom:36,fontWeight:400}}>Our revenue management experts handle demand forecasting, dynamic pricing, and competitor analysis so your hotel maximizes revenue every day, every season.</p>
